...
public class Form extends Tag {
	...
	private static final ParserTag parser = new ParserTag(Tag.FORM,
			ParserTag.CLOSING_TAG_YES);

	private static final ParserAttr parserAttrAction = new ParserAttr(
			Attr.ACTION);
	private static final ParserAttr parserAttrMethod = new ParserAttr(
			Attr.METHOD);
