...
//		this.setPreferredSize(new java.awt.Dimension(600,400));
	...
	private javax.swing.JButton getBtnStep() {
		if (btnStep == null) {
			...
			btnStep.setIcon(new ImageIcon(getClass().getResource("/resource/icons/control_start.png")));
	...
	private javax.swing.JButton getBtnContinue() {
		if (btnContinue == null) {
			...
			btnContinue.setIcon(new ImageIcon(getClass().getResource("/resource/icons/control_play.png")));
	...
	private JButton getBtnDrop() {
		if (btnDrop == null) {
			btnDrop = new JButton();
			btnDrop.setIcon(new ImageIcon(getClass().getResource("/resource/icons/stop.png")));
