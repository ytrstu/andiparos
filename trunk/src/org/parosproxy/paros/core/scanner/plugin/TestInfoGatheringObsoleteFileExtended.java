...
public class TestInfoGatheringObsoleteFileExtended extends AbstractAppPlugin {

	private final static String[] staticSuffixList = { ".OLD", ".Old", ".BAK", ".Bak", ".java", ".INC", ".Inc" };
	...
	public String getDescription() {
		String msg = "Miscellenous include files, backup, unused or obsolete files exist as indicated. "
			+ "If these files contain program source, information such as server logic or ODBC/JDBC user "
			+ "ID and passwords may be revealed since these file extension may not be processed by the "
			+ "web server.";
		return msg;
	}
