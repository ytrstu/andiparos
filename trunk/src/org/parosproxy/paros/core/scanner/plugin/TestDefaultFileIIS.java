...
public class TestDefaultFileIIS extends AbstractDefaultFilePlugin {
	...
	private void createURI() {
		...
		addTest(
				"_cti_pvt",
				"access.cnf,botinfs.cnf,bots.cnf,deptodoc.btr,dectodep.btr,linkinfo.cnf,service.cnf,services.cnf,svcacl.cnf,uniqperm.cnf,writeto.cnf");
		addTest(
				"_vti_bin,_private,_vti_cnf,_vti_log,_vti_pvt,_vti_script,vti_txt",
				"/");
		addTest("IISSamples/sdk/asp/docs",
				"CodeBrws.asp,ColorPicker.asp,libcodebrws.inc,sampfram.asp,toolbar.asp");
		addTest(
				"IISSamples/sdk/asp/applications",
				"Application_JScript.asp,Application_VBScript.asp,Session_JScript.asp,Session_VBScript.asp");
		addTest(
				"IISSamples/sdk/asp/database",
				"AddDelete_VBScript.asp,LimitRows_VBScript.asp,MultiScrolling_VBScript.asp,SimpleQuery_VBScript.asp,StoredProcedures_VBScript.asp,Update_VBScript.asp");
		...
		addTest(
				"/iissamples/ExAir",
				"default.asp,IEPush/Channel.asp,Catalog/Catalog.asp,FunNGames/FunNGames.asp,HowToReachUs.asp,About.asp");
		addTest("/iisadmin", "htmldocs/iisdocs.htm");
		addTest("/scripts/tools",
				"dsnform.exe,getdrvrs.exe,mkilog.exe,newdsn.exe");
		addTest(
				"/iisadmpwd",
				"achg.htr,aexp.htr,aexp2.htr,aexp2b.htr,aexp3.htr,aexp4.htr,aexp4b.htr,anot.htr,anot3.htr");
		addTest("/msadc", "adcjavas.inc,adcvbs.inc,msadcs.dll,readme.txt");
		addTest("/samples/dbsamp",
				"dbsamp.htm,dbsamp1.htm,dbsamp2.htm,dbsamp3.htm");
		addTest("/samples/gbook", "query.htm,register.htm");
		addTest("/samples/htmlsamp",
				"htmlsamp.htm,styles.htm,styles2.htm,tables.htm");
		addTest("/samples/isapi", "drop.htm,favlist.htm,isapi.htm,srch.htm");
		addTest(
				"/samples/sampsite",
				"about.htm,catalog.htm,default.htm,process.htm,results.htm,sampsite.htm,sendme.htm,taste.htm");
