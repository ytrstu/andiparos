...
public class FilterIfModifiedSince extends FilterAdaptor {
	 ...
	 * 
	 * @see
	 * com.proofsecure.paros.core.proxy.ProxyListener#onHttpRequestSend(com.
	...
	public void onHttpRequestSend(HttpMessage httpMessage) {
		...
		if (!reqHeader.isEmpty() && reqHeader.isText()) {
			String ifModifed = reqHeader
					.getHeader(HttpHeader.IF_MODIFIED_SINCE);
			if (ifModifed != null) {
	 ...
	 * 
	 * @see
	 * com.proofsecure.paros.core.proxy.ProxyListener#onHttpResponseReceive(
