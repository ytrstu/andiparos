...
public class SearchPanel extends AbstractPanel {
	...
	private  void initialize() {
		...
		this.setIcon(new ImageIcon(getClass().getResource("/resource/icons/find.png")));
	...
	private JButton getBtnSearch() {
		if (btnSearch == null) {
			...
			// 'magnifying glass' icon
			btnSearch.setIcon(new ImageIcon(getClass().getResource("/resource/icons/find.png")));
	...
	private JButton getBtnNext() {
		if (btnNext == null) {
			...
			// 'arrow down' icon
			btnNext.setIcon(new ImageIcon(getClass().getResource("/resource/icons/arrow_down.png")));
	...
	private JButton getBtnPrev() {
		if (btnPrev == null) {
			...
			// 'arrow up' icon
			btnPrev.setIcon(new ImageIcon(getClass().getResource("/resource/icons/arrow_up.png")));
