...
class Input extends Tag {
	...
	public static final String TEXT = "TEXT", HIDDEN = "HIDDEN",
			SUBMIT = "SUBMIT", CHECKBOX = "CHECKBOX", RADIO = "RADIO",
			RESET = "RESET", PASSWORD = "PASSWORD";

	private static final ParserTag parser = new ParserTag(Tag.INPUT,
