...
public class Meta extends org.parosproxy.paros.core.spider.Tag {
	...
	// parser for "Meta" tag
	private static final ParserTag parser = new ParserTag("META",
			ParserTag.CLOSING_TAG_OPTIONAL);

	// parser for "CONTENT" attribute in tag
	private static final ParserAttr parserAttrContent = new ParserAttr(
			Attr.CONTENT);
