...
public class TestInfoPrivateAddressDisclosure extends AbstractAppPlugin {
	...
	public static final Pattern patternPrivateIP = Pattern
			.compile(
	...
	public String getDescription() {
		return "Private IP such as 10.x.x.x, 172.x.x.x, 192.168.x.x have been found in the HTTP response body. This can be used in exploits on internal system.";
	}
