...
public class TestClientAutocomplete extends AbstractAppPlugin {
	...
	// used reluctant quantifer to make sure the same form and input element is
	// referred
	public final static Pattern patternForm = Pattern
			.compile("(<FORM\\s*[^>]+\\s*>)(.*?)</FORM>", PATTERN_PARAM
					| Pattern.DOTALL);
