...
public class TestInjectionCRLF extends AbstractAppParamPlugin {
	...
	private String randomString = "Tamper="
	...
	public String getDescription() {
		...
		String msg = "Cookie can be set via CRLF injection. It may also be possible to set arbitrary HTTP response header."
				+ CRLF
	...
	private boolean checkResult(HttpMessage msg, String query) {
		...
		Matcher matcher = patternCookieTamper.matcher(msg.getResponseHeader()
				.toString());
		if (matcher.find()) {
